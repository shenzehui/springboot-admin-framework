...
import com.marico.dto.AdminLoginParam;
...
public class UmsAdminController {
    ...
    public CommonResult login(@Validated @RequestBody AdminLoginParam usersLoginParam) {
        String token = adminService.login(usersLoginParam.getUsername(), usersLoginParam.getPassword());
        if (token == null) {
